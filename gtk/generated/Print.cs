...
#region Autogenerated code
	public class Print {
		...
		public static void RunPageSetupDialogAsync(Gtk.Window parent, Gtk.PageSetup page_setup, Gtk.PrintSettings settings, Gtk.PageSetupDoneFunc done_cb) {
			...
			if (done_cb != null) {
				gch = (IntPtr)GCHandle.Alloc (done_cb);
			}
			gtk_print_run_page_setup_dialog_async(parent == null ? IntPtr.Zero : parent.Handle, page_setup == null ? IntPtr.Zero : page_setup.Handle, settings == null ? IntPtr.Zero : settings.Handle, (done_cb == null) ? null : GtkSharp.PageSetupDoneFuncWrapper.NativeDelegate, (IntPtr)gch);
		}
