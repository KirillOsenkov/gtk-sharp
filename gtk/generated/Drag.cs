...
#region Autogenerated code
	public class Drag {
		...
		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void gtk_drag_set_default_icon(IntPtr colormap, IntPtr pixmap, IntPtr mask, int hot_x, int hot_y);

		[Obsolete]
		public static void SetDefaultIcon(Gdk.Colormap colormap, Gdk.Pixmap pixmap, Gdk.Pixmap mask, int hot_x, int hot_y) {
			Gtk.Application.AssertMainThread();
			gtk_drag_set_default_icon(colormap == null ? IntPtr.Zero : colormap.Handle, pixmap == null ? IntPtr.Zero : pixmap.Handle, mask == null ? IntPtr.Zero : mask.Handle, hot_x, hot_y);
		}
		...
		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void gtk_drag_set_icon_pixmap(IntPtr context, IntPtr colormap, IntPtr pixmap, IntPtr mask, int hot_x, int hot_y);

		public static void SetIconPixmap(Gdk.DragContext context, Gdk.Colormap colormap, Gdk.Pixmap pixmap, Gdk.Pixmap mask, int hot_x, int hot_y) {
			Gtk.Application.AssertMainThread();
			gtk_drag_set_icon_pixmap(context == null ? IntPtr.Zero : context.Handle, colormap == null ? IntPtr.Zero : colormap.Handle, pixmap == null ? IntPtr.Zero : pixmap.Handle, mask == null ? IntPtr.Zero : mask.Handle, hot_x, hot_y);
		}
		...
		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void gtk_drag_source_set_icon(IntPtr widget, IntPtr colormap, IntPtr pixmap, IntPtr mask);

		public static void SourceSetIcon(Gtk.Widget widget, Gdk.Colormap colormap, Gdk.Pixmap pixmap, Gdk.Pixmap mask) {
			Gtk.Application.AssertMainThread();
			gtk_drag_source_set_icon(widget == null ? IntPtr.Zero : widget.Handle, colormap == null ? IntPtr.Zero : colormap.Handle, pixmap == null ? IntPtr.Zero : pixmap.Handle, mask == null ? IntPtr.Zero : mask.Handle);
		}
