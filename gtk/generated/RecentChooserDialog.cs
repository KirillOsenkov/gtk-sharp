...
#region Autogenerated code
	...
	public class RecentChooserDialog : Gtk.Dialog, Gtk.RecentChooser {
		...
		[Obsolete]
		protected RecentChooserDialog(GLib.GType gtype) : base(gtype) {}
		public RecentChooserDialog(IntPtr raw) : base(raw) {}

		protected RecentChooserDialog() : base(IntPtr.Zero)
		{
			CreateNativeObject (Array.Empty<IntPtr> (), Array.Empty<GLib.Value> (), 0);
		}

		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_recent_chooser_dialog_get_type();

		static GLib.GType _gtype = new GLib.GType (gtk_recent_chooser_dialog_get_type());
		...
		{
			try {
				RecentChooserDialog chooser_managed = GLib.Object.GetObject (chooser, false) as RecentChooserDialog;
		...
		[GLib.DefaultSignalHandler(Type=typeof(Gtk.RecentChooserDialog), ConnectionMethod="OverrideSelectionChanged")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(Gtk.RecentChooserDialog), ConnectionMethod="OverrideItemActivated")]
...
#line 1 "RecentChooserDialog.custom"
	...
	internal class RecentChooserDialogAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_recent_chooser_dialog_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gtk_recent_chooser_dialog_get_type ());
