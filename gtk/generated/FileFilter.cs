...
#region Autogenerated code
	...
	public class FileFilter : Gtk.Object {
		...
		[Obsolete]
		protected FileFilter(GLib.GType gtype) : base(gtype) {}
		...
		public void AddCustom(Gtk.FileFilterFlags needed, Gtk.FileFilterFunc func) {
			...
			gtk_file_filter_add_custom(Handle, (int) needed, (func == null) ? null : GtkSharp.FileFilterFuncWrapper.NativeDelegate, data, notify);
		}
		...
		static GLib.GType _gtype = new GLib.GType (gtk_file_filter_get_type());
	...
	internal class FileFilterAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_file_filter_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gtk_file_filter_get_type ());
