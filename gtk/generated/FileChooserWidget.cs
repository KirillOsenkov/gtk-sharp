...
#region Autogenerated code
	...
	public class FileChooserWidget : Gtk.VBox, Gtk.FileChooser {
		...
		[Obsolete]
		protected FileChooserWidget(GLib.GType gtype) : base(gtype) {}
		...
		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_file_chooser_widget_new_with_backend(int action, IntPtr backend);

		public FileChooserWidget (Gtk.FileChooserAction action, string backend) : base (IntPtr.Zero)
		{
			if (GetType () != typeof (FileChooserWidget)) {
				Gtk.Application.AssertMainThread();
				throw new InvalidOperationException ("Can't override this constructor.");
			...
			owned = true;
			Raw = gtk_file_chooser_widget_new_with_backend((int) action, native_backend);
		...
		static GLib.GType _gtype = new GLib.GType (gtk_file_chooser_widget_get_type());
		...
		{
			try {
				FileChooserWidget chooser_managed = GLib.Object.GetObject (chooser, false) as FileChooserWidget;
...
#line 1 "FileChooserWidget.custom"
...
// Boston, MA 02111-1307, USA.
	...
	internal class FileChooserWidgetAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_file_chooser_widget_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gtk_file_chooser_widget_get_type ());
