...
#region Autogenerated code
	...
	public class RecentChooserMenu : Gtk.Menu, Gtk.RecentChooser {
		...
		[Obsolete]
		protected RecentChooserMenu(GLib.GType gtype) : base(gtype) {}
		...
		static GLib.GType _gtype = new GLib.GType (gtk_recent_chooser_menu_get_type());
		...
		{
			try {
				RecentChooserMenu chooser_managed = GLib.Object.GetObject (chooser, false) as RecentChooserMenu;
		...
		[GLib.DefaultSignalHandler(Type=typeof(Gtk.RecentChooserMenu), ConnectionMethod="OverrideSelectionChanged")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(Gtk.RecentChooserMenu), ConnectionMethod="OverrideItemActivated")]
...
#line 1 "RecentChooserMenu.custom"
	...
	internal class RecentChooserMenuAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_recent_chooser_menu_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gtk_recent_chooser_menu_get_type ());
