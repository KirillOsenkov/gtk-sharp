	...
	public class Builder : GLib.Object {
		...
		public GLib.Object[] Objects { 
			get {
				...
				GLib.Object[] ret = GLib.Marshaller.ListPtrToArray<GLib.Object> (raw_ret, typeof(GLib.SList), true, false);
				return ret;
			}
		}
		...
		static GLib.GType _gtype = new GLib.GType (gtk_builder_get_type());
...
void BindFields (object target, Type type)
{
	...
	internal class BuilderAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_builder_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gtk_builder_get_type ());
