...
#region Autogenerated code
	...
	public class TreeStore : GLib.Object, Gtk.TreeModel, Gtk.TreeDragSource, Gtk.TreeDragDest, Gtk.TreeSortable {
		...
		[Obsolete]
		protected TreeStore(GLib.GType gtype) : base(gtype) {}
		...
		static GLib.GType _gtype = new GLib.GType (gtk_tree_store_get_type());
		...
		{
			try {
				TreeStore sortable_managed = GLib.Object.GetObject (sortable, false) as TreeStore;
...
// Boston, MA 02111-1307, USA.
		...
		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention=CallingConvention.Cdecl)]
		unsafe static extern void gtk_tree_store_insert_with_valuesv(IntPtr raw, out TreeIter iter, IntPtr parent, int position, int* columns, GLib.Value* values, int n_values);

		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention=CallingConvention.Cdecl)]
		unsafe static extern void gtk_tree_store_insert_with_valuesv(IntPtr raw, out TreeIter iter, ref TreeIter parent, int position, int* columns, GLib.Value* values, int n_values);
		...
		[DllImport("libgtk-win32-2.0-0.dll", CallingConvention=CallingConvention.Cdecl)]
		unsafe static extern void gtk_tree_store_set_valuesv(IntPtr raw, ref TreeIter iter, int* columns, GLib.Value* values, int n_values);
	...
	internal class TreeStoreAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_tree_store_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gtk_tree_store_get_type ());
