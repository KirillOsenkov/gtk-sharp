...
#region Autogenerated code
	...
	public class CellRendererCombo : Gtk.CellRendererText {
		...
		[Obsolete]
		protected CellRendererCombo(GLib.GType gtype) : base(gtype) {}
		...
		public int TextColumn {
			get {
				using (GLib.Value val = GetProperty ("text-column")) {
					int ret = (int) val;
					return ret;
				}
			}
		...
		public bool HasEntry {
			get {
				using (GLib.Value val = GetProperty ("has-entry")) {
					bool ret = (bool) val;
					return ret;
				}
			}
		...
		static GLib.GType _gtype = new GLib.GType (gtk_cell_renderer_combo_get_type());
...
#line 1 "CellRendererCombo.custom"
//
...
// Boston, MA 02111-1307, USA.
	...
	internal class CellRendererComboAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgtk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_cell_renderer_combo_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gtk_cell_renderer_combo_get_type ());
