...
#region Autogenerated code
	...
	public class StateSet : GLib.Object {
		...
		[Obsolete]
		protected StateSet(GLib.GType gtype) : base(gtype) {}
		...
		static GLib.GType _gtype = new GLib.GType (atk_state_set_get_type());
	...
	internal class StateSetAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libatk-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr atk_state_set_get_type ();

		private static GLib.GType _gtype = new GLib.GType (atk_state_set_get_type ());
