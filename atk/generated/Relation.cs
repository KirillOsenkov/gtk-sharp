...
#region Autogenerated code
	...
	public class Relation : GLib.Object {
		...
		[Obsolete]
		protected Relation(GLib.GType gtype) : base(gtype) {}
		...
		static GLib.GType _gtype = new GLib.GType (atk_relation_get_type());
	...
	internal class RelationAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libatk-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr atk_relation_get_type ();

		private static GLib.GType _gtype = new GLib.GType (atk_relation_get_type ());
