...
#region Autogenerated code
	...
	public class Pixbuf : GLib.Object {
		...
		[Obsolete]
		protected Pixbuf(GLib.GType gtype) : base(gtype) {}
		...
		public Pixbuf (Gdk.Colorspace colorspace, bool has_alpha, int bits_per_sample, int width, int height) : base (IntPtr.Zero)
		{
			if (GetType () != typeof (Pixbuf)) {
				unsafe {
					...
					names[0] = GLib.Marshaller.StringToPtrGStrdup ("colorspace");
					vals[0] = new GLib.Value (colorspace);
					names[1] = GLib.Marshaller.StringToPtrGStrdup ("has_alpha");
					vals[1] = new GLib.Value (has_alpha);
					names[2] = GLib.Marshaller.StringToPtrGStrdup ("bits_per_sample");
					vals[2] = new GLib.Value (bits_per_sample);
					names[3] = GLib.Marshaller.StringToPtrGStrdup ("width");
					vals[3] = new GLib.Value (width);
					names[4] = GLib.Marshaller.StringToPtrGStrdup ("height");
					vals[4] = new GLib.Value (height);
		...
		static GLib.GType _gtype = new GLib.GType (gdk_pixbuf_get_type());
...
// Boston, MA 02111-1307, USA.
		...
		class DestroyHelper {
			...
			static void ReleaseHandles (IntPtr buf, IntPtr data)
			{
				var gch = (GCHandle)data;

				var wrapper = (DestroyHelper)gch.Target;
				if (wrapper.notify != null)
					wrapper.notify ((byte[])wrapper.data_handle.Target);

				wrapper.data_handle.Free ();
				gch.Free ();
			}

			static NativeDelegate handler = new NativeDelegate (ReleaseHandles);
			public static NativeDelegate Handler {
				get {
					return handler;
				}
			}
		...
		public Pixbuf (byte[] data, Gdk.Colorspace colorspace, bool has_alpha, int bits_per_sample, int width, int height, int rowstride, Gdk.PixbufDestroyNotify destroy_fn) : base (IntPtr.Zero)
		{
			...
			var helper = new DestroyHelper (data, destroy_fn);
			var gch = GCHandle.Alloc (helper);
			Raw = gdk_pixbuf_new_from_data(data, (int) colorspace, has_alpha, bits_per_sample, width, height, rowstride, DestroyHelper.Handler, (IntPtr)gch);
		}
...
//
	...
	internal class PixbufAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libgdk_pixbuf-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gdk_pixbuf_get_type ();

		private static GLib.GType _gtype = new GLib.GType (gdk_pixbuf_get_type ());
