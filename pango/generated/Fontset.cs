...
#region Autogenerated code
	...
	public class Fontset : GLib.Object {
		...
		[Obsolete]
		protected Fontset(GLib.GType gtype) : base(gtype) {}
		...
		public void Foreach(Pango.FontsetForeachFunc func) {
			...
			pango_fontset_foreach(Handle, (func == null) ? null : PangoSharp.FontsetForeachFuncWrapper.NativeDelegate, (IntPtr)gch);
			gch.Free();
		}
		...
		static GLib.GType _gtype = new GLib.GType (pango_fontset_get_type());
	...
	internal class FontsetAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libpango-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr pango_fontset_get_type ();

		private static GLib.GType _gtype = new GLib.GType (pango_fontset_get_type ());
