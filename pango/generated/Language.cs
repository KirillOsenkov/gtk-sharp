...
#region Autogenerated code
	[Language]
	public class Language : GLib.Opaque {
		...
		static GLib.GType _gtype = new GLib.GType (pango_language_get_type());
	...
	internal class LanguageAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libpango-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr pango_language_get_type ();

		private static GLib.GType _gtype = new GLib.GType (pango_language_get_type ());
