...
#region Autogenerated code
	[FontDescription]
	public class FontDescription : GLib.Opaque {
		...
		static GLib.GType _gtype = new GLib.GType (pango_font_description_get_type());
	...
	internal class FontDescriptionAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libpango-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr pango_font_description_get_type ();

		private static GLib.GType _gtype = new GLib.GType (pango_font_description_get_type ());
